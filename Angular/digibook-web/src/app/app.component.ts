  ...
  constructor(private http: HttpClient , public auth: AuthService){
    ...
    ngOnInit(): void {
      this.menuItems = [
        ...
        { label: 'Login', icon: 'fa fa-calendar', routerLink:['/login'] },
        { label: 'Registration', icon: 'fa fa-calendar', routerLink:['/register'] },
        { label: 'Statistic', icon: 'fa fa-calendar', routerLink:['/statistic'] }
      ];
      this.items = [
        {
