...
namespace BlastAsia.DigiBook.Infrastructure.Persistence.Test
{
    ...
    public class VenueRepositoryTest
    {
        ...
        [TestMethod]
        [TestProperty("TestType", "Integration")]
        public void Delete__WithAnExistingVenue_RemovesRecordFromDatabase()
        {
        ...
        public void Update_WithValidData_SavesUpdatesInDb()
        {
            //Arrange
            var newVenue = sut.Create(venue);
            var expectedVenue = "Room A ";

            newVenue.VenueName = expectedVenue;
            ...
            Assert.AreEqual(expectedVenue, updatedVenue.VenueName);
