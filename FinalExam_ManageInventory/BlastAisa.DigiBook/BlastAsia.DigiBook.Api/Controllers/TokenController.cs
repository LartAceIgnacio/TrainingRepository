...
using BlastAisa.DigiBook.Infrastructure.Security;
...
namespace BlastAsia.DigiBook.Api.Controllers
{
    public class TokenController : BaseApiController
    {
        ...
        #region Constructor
        public TokenController(DigiBookDbContext context, RoleManager<ApplicationRole> roleManager, UserManager<ApplicationUser> userManager, IConfiguration configuration)
