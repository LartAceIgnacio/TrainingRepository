...
export class ReservationsComponent implements OnInit {
  ...
  paginate(event){
    this.globalservice.getRecordWithPagination<PaginationResult<Reservation>>(
  ...
  saveAndNewReservation(){
    ...
    this.globalservice.addRecord<Reservation>("Reservations", this.selectedReservation).then(reservations =>{
  ...
  saveReservation(){
    ...
    if (this.isNewReservation) {
      ...
      this.globalservice.updateRecord<Reservation>("Reservations",this.selectedReservation.reservationId,this.selectedReservation)
      .then(reservations =>{
  ...
  deleteReservation(){
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        this.globalservice.deleteRecord<Reservation>("Reservations", this.selectedReservation.reservationId);
        this.selectedReservation = null;
      }
    });
  }
