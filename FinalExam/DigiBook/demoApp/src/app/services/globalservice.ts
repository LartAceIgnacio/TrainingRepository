...
export class GlobalService {
    ...
    getRecordWithPagination<T> (serviceName: string, page: number, 
    ...
    getRecord<T> (serviceName: string) {
    ...
    addRecord<T>(serviceName: string, objEntity: T) {
    ...
    deleteRecord<T>(serviceName: string, id) {
    ...
    updateRecord<T>(serviceName: string, id, objEntity: T) {
