...
export class ContactService {
    ...
    postContacts(objectContact) {
        return this.http.post(this.serviceUrl, objectContact)
        .toPromise()
        // tslint:disable-next-line:arrow-return-shorthand
        .then(data => { return data as Contact[]; })
        .catch(this.handleError);
    }
    putContacts(contactId, objectContact) {
        return this.http.put(`${this.serviceUrl}?id=${contactId}`, objectContact)
        .toPromise()
